 ...
 */
@Generated
public class JpaRepositoryFactoryBean__TestContext004_Autowiring1 {
  /**
  ...
  public static JpaRepositoryFactoryBean apply(RegisteredBean registeredBean,
    ...
    AutowiredMethodArgumentsResolver.forRequiredMethod("setQueryMethodFactory", ObjectProvider.class).resolve(registeredBean, args -> instance.setQueryMethodFactory(args.get(0)));
    return instance;
  }
}
