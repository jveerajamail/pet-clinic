 ...
 */
@Generated
public class JacksonAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  /**
   * Get the bean instance supplier for 'jsonFactory'.
   */
  private static BeanInstanceSupplier<JsonFactory> getJsonFactoryInstanceSupplier() {
    return BeanInstanceSupplier.<JsonFactory>forFactoryMethod(JacksonAutoConfiguration.class, "jsonFactory", List.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration", JacksonAutoConfiguration.class).jsonFactory(args.get(0)));
  }

  /**
   * Get the bean definition for 'jsonFactory'.
   */
  public static BeanDefinition getJsonFactoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JsonFactory.class);
    beanDefinition.setFactoryBeanName("org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration");
    beanDefinition.setInstanceSupplier(getJsonFactoryInstanceSupplier());
    return beanDefinition;
  }
  ...
  private static BeanInstanceSupplier<JsonMapper.Builder> getJsonMapperBuilderInstanceSupplier() {
    return BeanInstanceSupplier.<JsonMapper.Builder>forFactoryMethod(JacksonAutoConfiguration.class, "jsonMapperBuilder", List.class, JsonFactory.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration", JacksonAutoConfiguration.class).jsonMapperBuilder(args.get(0), args.get(1)));
  }
  ...
  /**
   * Bean definitions for {@link JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration}.
   */
  @Generated
  public static class JacksonJsonCustomizerConfiguration {
    /**
     * Get the bean instance supplier for 'org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration$JacksonJsonCustomizerConfiguration'.
     */
    private static BeanInstanceSupplier<JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration> getJacksonJsonCustomizerConfigurationInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration>forConstructor(JacksonProperties.class)
              .withGenerator((registeredBean, args) -> new JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration(args.get(0)));
    }

    /**
     * Get the bean definition for 'jacksonJsonCustomizerConfiguration'.
     */
    public static BeanDefinition getJacksonJsonCustomizerConfigurationBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.class);
      beanDefinition.setInstanceSupplier(getJacksonJsonCustomizerConfigurationInstanceSupplier());
      return beanDefinition;
    }

    /**
     * Get the bean instance supplier for 'standardJsonFactoryBuilderCustomizer'.
     */
    private static BeanInstanceSupplier<JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.StandardJsonFactoryBuilderCustomizer> getStandardJsonFactoryBuilderCustomizerInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.StandardJsonFactoryBuilderCustomizer>forFactoryMethod(JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.class, "standardJsonFactoryBuilderCustomizer")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration$JacksonJsonCustomizerConfiguration", JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.class).standardJsonFactoryBuilderCustomizer());
    }

    /**
     * Get the bean definition for 'standardJsonFactoryBuilderCustomizer'.
     */
    public static BeanDefinition getStandardJsonFactoryBuilderCustomizerBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.StandardJsonFactoryBuilderCustomizer.class);
      beanDefinition.setFactoryBeanName("org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration$JacksonJsonCustomizerConfiguration");
      beanDefinition.setInstanceSupplier(getStandardJsonFactoryBuilderCustomizerInstanceSupplier());
      return beanDefinition;
    }
     ...
     */
    private static BeanInstanceSupplier<JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.StandardJsonMapperBuilderCustomizer> getStandardJsonMapperBuilderCustomizerInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.StandardJsonMapperBuilderCustomizer>forFactoryMethod(JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.class, "standardJsonMapperBuilderCustomizer", ObjectProvider.class, AutowireCapableBeanFactory.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration$JacksonJsonCustomizerConfiguration", JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.class).standardJsonMapperBuilderCustomizer(args.get(0), args.get(1)));
    }
    ...
    public static BeanDefinition getStandardJsonMapperBuilderCustomizerBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(JacksonAutoConfiguration.JacksonJsonCustomizerConfiguration.StandardJsonMapperBuilderCustomizer.class);
      beanDefinition.setFactoryBeanName("org.springframework.boot.jackson.autoconfigure.JacksonAutoConfiguration$JacksonJsonCustomizerConfiguration");
