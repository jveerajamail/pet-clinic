 ...
 */
@Generated
public class TomcatMetricsAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<TomcatMetricsBinder> getTomcatMetricsBinderInstanceSupplier(
    ...
    return BeanInstanceSupplier.<TomcatMetricsBinder>forFactoryMethod(TomcatMetricsAutoConfiguration.class, "tomcatMetricsBinder", MeterRegistry.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.tomcat.autoconfigure.metrics.TomcatMetricsAutoConfiguration", TomcatMetricsAutoConfiguration.class).tomcatMetricsBinder(args.get(0)));
  }
  ...
  public static BeanDefinition getTomcatMetricsBinderBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.tomcat.autoconfigure.metrics.TomcatMetricsAutoConfiguration");
