 ...
 */
@Generated
public class ImportsContextCustomizer__TestContext005_BeanDefinitions {
  /**
  ...
  public static class ImportsCleanupPostProcessor {
    ...
    public static BeanDefinition getImportsCleanupPostProcessorBeanDefinition() {
      ...
      beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, new String[] {"org.springframework.samples.petclinic.system.CrashControllerIntegrationTests"});
