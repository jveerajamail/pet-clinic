 ...
 */
@Generated
public class TransactionManagerCustomizationAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<TransactionManagerCustomizers> getPlatformTransactionManagerCustomizersInstanceSupplier(
    ...
    return BeanInstanceSupplier.<TransactionManagerCustomizers>forFactoryMethod(TransactionManagerCustomizationAutoConfiguration.class, "platformTransactionManagerCustomizers", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.transaction.autoconfigure.TransactionManagerCustomizationAutoConfiguration", TransactionManagerCustomizationAutoConfiguration.class).platformTransactionManagerCustomizers(args.get(0)));
  }
  ...
  public static BeanDefinition getPlatformTransactionManagerCustomizersBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.transaction.autoconfigure.TransactionManagerCustomizationAutoConfiguration");
  ...
  private static BeanInstanceSupplier<ExecutionListenersTransactionManagerCustomizer> getTransactionExecutionListenersInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ExecutionListenersTransactionManagerCustomizer>forFactoryMethod(TransactionManagerCustomizationAutoConfiguration.class, "transactionExecutionListeners", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.transaction.autoconfigure.TransactionManagerCustomizationAutoConfiguration", TransactionManagerCustomizationAutoConfiguration.class).transactionExecutionListeners(args.get(0)));
  }
