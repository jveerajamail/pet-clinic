 ...
 */
@Generated
public class InfoEndpointAutoConfiguration__TestContext003_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<InfoEndpoint> getInfoEndpointInstanceSupplier() {
    return BeanInstanceSupplier.<InfoEndpoint>forFactoryMethod(InfoEndpointAutoConfiguration.class, "infoEndpoint", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.info.InfoEndpointAutoConfiguration", InfoEndpointAutoConfiguration.class).infoEndpoint(args.get(0)));
  }
  ...
  public static BeanDefinition getInfoEndpointBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.info.InfoEndpointAutoConfiguration");
