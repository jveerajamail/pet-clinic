 ...
 */
@Generated
public class LoggersEndpointAutoConfiguration__TestContext003_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<LoggersEndpoint> getLoggersEndpointInstanceSupplier() {
    return BeanInstanceSupplier.<LoggersEndpoint>forFactoryMethod(LoggersEndpointAutoConfiguration.class, "loggersEndpoint", LoggingSystem.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.actuate.autoconfigure.logging.LoggersEndpointAutoConfiguration", LoggersEndpointAutoConfiguration.class).loggersEndpoint(args.get(0), args.get(1)));
  }
  ...
  public static BeanDefinition getLoggersEndpointBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.actuate.autoconfigure.logging.LoggersEndpointAutoConfiguration");
