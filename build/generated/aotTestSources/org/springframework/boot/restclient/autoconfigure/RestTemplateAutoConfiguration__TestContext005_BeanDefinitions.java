 ...
 */
@Generated
public class RestTemplateAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<RestTemplateBuilderConfigurer> getRestTemplateBuilderConfigurerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<RestTemplateBuilderConfigurer>forFactoryMethod(RestTemplateAutoConfiguration.class, "restTemplateBuilderConfigurer", ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.restclient.autoconfigure.RestTemplateAutoConfiguration", RestTemplateAutoConfiguration.class).restTemplateBuilderConfigurer(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4)));
  }
  ...
  public static BeanDefinition getRestTemplateBuilderConfigurerBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.restclient.autoconfigure.RestTemplateAutoConfiguration");
  ...
  private static BeanInstanceSupplier<RestTemplateBuilder> getRestTemplateBuilderInstanceSupplier(
    ...
    return BeanInstanceSupplier.<RestTemplateBuilder>forFactoryMethod(RestTemplateAutoConfiguration.class, "restTemplateBuilder", RestTemplateBuilderConfigurer.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.restclient.autoconfigure.RestTemplateAutoConfiguration", RestTemplateAutoConfiguration.class).restTemplateBuilder(args.get(0)));
  }
