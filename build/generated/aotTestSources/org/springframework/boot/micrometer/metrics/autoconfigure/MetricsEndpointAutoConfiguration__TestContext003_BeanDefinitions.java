 ...
 */
@Generated
public class MetricsEndpointAutoConfiguration__TestContext003_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<MetricsEndpoint> getMetricsEndpointInstanceSupplier() {
    return BeanInstanceSupplier.<MetricsEndpoint>forFactoryMethod(MetricsEndpointAutoConfiguration.class, "metricsEndpoint", MeterRegistry.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.MetricsEndpointAutoConfiguration", MetricsEndpointAutoConfiguration.class).metricsEndpoint(args.get(0)));
  }
  ...
  public static BeanDefinition getMetricsEndpointBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.micrometer.metrics.autoconfigure.MetricsEndpointAutoConfiguration");
