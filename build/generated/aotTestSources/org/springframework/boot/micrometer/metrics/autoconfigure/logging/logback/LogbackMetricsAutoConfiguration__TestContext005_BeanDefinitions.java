 ...
 */
@Generated
public class LogbackMetricsAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<LogbackMetrics> getLogbackMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<LogbackMetrics>forFactoryMethod(LogbackMetricsAutoConfiguration.class, "logbackMetrics")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.logging.logback.LogbackMetricsAutoConfiguration", LogbackMetricsAutoConfiguration.class).logbackMetrics());
  }
  ...
  public static BeanDefinition getLogbackMetricsBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.micrometer.metrics.autoconfigure.logging.logback.LogbackMetricsAutoConfiguration");
