 ...
 */
@Generated
public class SystemMetricsAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<UptimeMetrics> getUptimeMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<UptimeMetrics>forFactoryMethod(SystemMetricsAutoConfiguration.class, "uptimeMetrics")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.system.SystemMetricsAutoConfiguration", SystemMetricsAutoConfiguration.class).uptimeMetrics());
  }
  ...
  public static BeanDefinition getUptimeMetricsBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.micrometer.metrics.autoconfigure.system.SystemMetricsAutoConfiguration");
  ...
  private static BeanInstanceSupplier<ProcessorMetrics> getProcessorMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<ProcessorMetrics>forFactoryMethod(SystemMetricsAutoConfiguration.class, "processorMetrics", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.system.SystemMetricsAutoConfiguration", SystemMetricsAutoConfiguration.class).processorMetrics(args.get(0)));
  }
  ...
  private static BeanInstanceSupplier<FileDescriptorMetrics> getFileDescriptorMetricsInstanceSupplier(
    ...
    return BeanInstanceSupplier.<FileDescriptorMetrics>forFactoryMethod(SystemMetricsAutoConfiguration.class, "fileDescriptorMetrics")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.system.SystemMetricsAutoConfiguration", SystemMetricsAutoConfiguration.class).fileDescriptorMetrics());
  }
  ...
  private static BeanInstanceSupplier<DiskSpaceMetricsBinder> getDiskSpaceMetricsInstanceSupplier(
    ...
    return BeanInstanceSupplier.<DiskSpaceMetricsBinder>forFactoryMethod(SystemMetricsAutoConfiguration.class, "diskSpaceMetrics", MetricsProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.system.SystemMetricsAutoConfiguration", SystemMetricsAutoConfiguration.class).diskSpaceMetrics(args.get(0)));
  }
