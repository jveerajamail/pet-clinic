 ...
 */
@Generated
public class MetricsAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<MetricsAutoConfiguration.MeterRegistryCloser> getMeterRegistryCloserInstanceSupplier(
    ...
    return BeanInstanceSupplier.<MetricsAutoConfiguration.MeterRegistryCloser>forFactoryMethod(MetricsAutoConfiguration.class, "meterRegistryCloser", ApplicationContext.class, MetricsProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.MetricsAutoConfiguration", MetricsAutoConfiguration.class).meterRegistryCloser(args.get(0), args.get(1)));
  }
