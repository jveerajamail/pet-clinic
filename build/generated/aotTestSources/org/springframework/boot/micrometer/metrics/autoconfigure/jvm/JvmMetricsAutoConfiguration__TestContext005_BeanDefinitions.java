 ...
 */
@Generated
public class JvmMetricsAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<JvmGcMetrics> getJvmGcMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<JvmGcMetrics>forFactoryMethod(JvmMetricsAutoConfiguration.class, "jvmGcMetrics")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration", JvmMetricsAutoConfiguration.class).jvmGcMetrics());
  }
  ...
  public static BeanDefinition getJvmGcMetricsBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration");
  ...
  private static BeanInstanceSupplier<JvmHeapPressureMetrics> getJvmHeapPressureMetricsInstanceSupplier(
    ...
    return BeanInstanceSupplier.<JvmHeapPressureMetrics>forFactoryMethod(JvmMetricsAutoConfiguration.class, "jvmHeapPressureMetrics")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration", JvmMetricsAutoConfiguration.class).jvmHeapPressureMetrics());
  }
  ...
  private static BeanInstanceSupplier<JvmMemoryMetrics> getJvmMemoryMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<JvmMemoryMetrics>forFactoryMethod(JvmMetricsAutoConfiguration.class, "jvmMemoryMetrics", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration", JvmMetricsAutoConfiguration.class).jvmMemoryMetrics(args.get(0)));
  }
  ...
  private static BeanInstanceSupplier<JvmThreadMetrics> getJvmThreadMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<JvmThreadMetrics>forFactoryMethod(JvmMetricsAutoConfiguration.class, "jvmThreadMetrics", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration", JvmMetricsAutoConfiguration.class).jvmThreadMetrics(args.get(0)));
  }
  ...
  private static BeanInstanceSupplier<ClassLoaderMetrics> getClassLoaderMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<ClassLoaderMetrics>forFactoryMethod(JvmMetricsAutoConfiguration.class, "classLoaderMetrics", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration", JvmMetricsAutoConfiguration.class).classLoaderMetrics(args.get(0)));
  }
  ...
  private static BeanInstanceSupplier<JvmInfoMetrics> getJvmInfoMetricsInstanceSupplier() {
    return BeanInstanceSupplier.<JvmInfoMetrics>forFactoryMethod(JvmMetricsAutoConfiguration.class, "jvmInfoMetrics")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration", JvmMetricsAutoConfiguration.class).jvmInfoMetrics());
  }
  ...
  private static BeanInstanceSupplier<JvmCompilationMetrics> getJvmCompilationMetricsInstanceSupplier(
    ...
    return BeanInstanceSupplier.<JvmCompilationMetrics>forFactoryMethod(JvmMetricsAutoConfiguration.class, "jvmCompilationMetrics")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.jvm.JvmMetricsAutoConfiguration", JvmMetricsAutoConfiguration.class).jvmCompilationMetrics());
  }
