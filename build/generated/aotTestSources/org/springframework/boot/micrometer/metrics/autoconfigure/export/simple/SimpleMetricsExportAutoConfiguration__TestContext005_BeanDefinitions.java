 ...
 */
@Generated
public class SimpleMetricsExportAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<SimpleMeterRegistry> getSimpleMeterRegistryInstanceSupplier(
    ...
    return BeanInstanceSupplier.<SimpleMeterRegistry>forFactoryMethod(SimpleMetricsExportAutoConfiguration.class, "simpleMeterRegistry", SimpleConfig.class, Clock.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.export.simple.SimpleMetricsExportAutoConfiguration", SimpleMetricsExportAutoConfiguration.class).simpleMeterRegistry(args.get(0), args.get(1)));
  }
  ...
  public static BeanDefinition getSimpleMeterRegistryBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.micrometer.metrics.autoconfigure.export.simple.SimpleMetricsExportAutoConfiguration");
  ...
  private static BeanInstanceSupplier<SimpleConfig> getSimpleConfigInstanceSupplier() {
    return BeanInstanceSupplier.<SimpleConfig>forFactoryMethod(SimpleMetricsExportAutoConfiguration.class, "simpleConfig", SimpleProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.micrometer.metrics.autoconfigure.export.simple.SimpleMetricsExportAutoConfiguration", SimpleMetricsExportAutoConfiguration.class).simpleConfig(args.get(0)));
  }
