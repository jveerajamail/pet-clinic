...
public class HealthEndpointConfiguration__TestContext002_BeanDefinitions {
   ...
   */
  private static BeanInstanceSupplier<HealthContributorMembershipValidator> getHealthEndpointGroupMembershipValidatorInstanceSupplier(
      ) {
    return BeanInstanceSupplier.<HealthContributorMembershipValidator>forFactoryMethod(HealthEndpointConfiguration.class, "healthEndpointGroupMembershipValidator", HealthEndpointProperties.class, HealthContributorRegistry.class, ObjectProvider.class)
  ...
  public static BeanDefinition getHealthEndpointGroupMembershipValidatorBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(HealthContributorMembershipValidator.class);
    beanDefinition.setFactoryBeanName("org.springframework.boot.health.autoconfigure.actuate.endpoint.HealthEndpointConfiguration");
