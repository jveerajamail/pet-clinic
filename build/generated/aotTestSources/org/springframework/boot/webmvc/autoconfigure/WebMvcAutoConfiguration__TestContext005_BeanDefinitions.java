 ...
 */
@Generated
public class WebMvcAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<OrderedFormContentFilter> getFormContentFilterInstanceSupplier(
    ...
    return BeanInstanceSupplier.<OrderedFormContentFilter>forFactoryMethod(WebMvcAutoConfiguration.class, "formContentFilter")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration", WebMvcAutoConfiguration.class).formContentFilter());
  }
  ...
  public static BeanDefinition getFormContentFilterBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration");
  ...
  public static class WebMvcAutoConfigurationAdapter {
    /**
     * Get the bean instance supplier for 'org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$WebMvcAutoConfigurationAdapter'.
     */
    private static BeanInstanceSupplier<WebMvcAutoConfiguration.WebMvcAutoConfigurationAdapter> getWebMvcAutoConfigurationAdapterInstanceSupplier(
      ...
      return BeanInstanceSupplier.<WebMvcAutoConfiguration.WebMvcAutoConfigurationAdapter>forConstructor(WebProperties.class, WebMvcProperties.class, ListableBeanFactory.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class)
              .withGenerator((registeredBean, args) -> new WebMvcAutoConfiguration.WebMvcAutoConfigurationAdapter(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4), args.get(5), args.get(6), args.get(7), args.get(8), args.get(9)));
    }
    ...
    private static BeanInstanceSupplier<InternalResourceViewResolver> getDefaultViewResolverInstanceSupplier(
      ...
      return BeanInstanceSupplier.<InternalResourceViewResolver>forFactoryMethod(WebMvcAutoConfiguration.WebMvcAutoConfigurationAdapter.class, "defaultViewResolver")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$WebMvcAutoConfigurationAdapter", WebMvcAutoConfiguration.WebMvcAutoConfigurationAdapter.class).defaultViewResolver());
    }
    ...
    public static BeanDefinition getDefaultViewResolverBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$WebMvcAutoConfigurationAdapter");
    ...
    private static BeanInstanceSupplier<ContentNegotiatingViewResolver> getViewResolverInstanceSupplier(
      ...
      return BeanInstanceSupplier.<ContentNegotiatingViewResolver>forFactoryMethod(WebMvcAutoConfiguration.WebMvcAutoConfigurationAdapter.class, "viewResolver", BeanFactory.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$WebMvcAutoConfigurationAdapter", WebMvcAutoConfiguration.WebMvcAutoConfigurationAdapter.class).viewResolver(args.get(0)));
    }
  ...
  public static class EnableWebMvcConfiguration {
    /**
     * Get the bean instance supplier for 'org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration'.
     */
    ...
    public static BeanDefinition getEnableWebMvcConfigurationBeanDefinition() {
      ...
      instanceSupplier = instanceSupplier.andThen(WebMvcAutoConfiguration_EnableWebMvcConfiguration__TestContext005_Autowiring::apply);
    ...
    private static BeanInstanceSupplier<WelcomePageHandlerMapping> getWelcomePageHandlerMappingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<WelcomePageHandlerMapping>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "welcomePageHandlerMapping", ApplicationContext.class, FormattingConversionService.class, ResourceUrlProvider.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration", WebMvcAutoConfiguration.EnableWebMvcConfiguration.class).welcomePageHandlerMapping(args.get(0), args.get(1), args.get(2)));
    }
    ...
    public static BeanDefinition getWelcomePageHandlerMappingBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration");
    ...
    private static BeanInstanceSupplier<WelcomePageNotAcceptableHandlerMapping> getWelcomePageNotAcceptableHandlerMappingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<WelcomePageNotAcceptableHandlerMapping>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "welcomePageNotAcceptableHandlerMapping", ApplicationContext.class, FormattingConversionService.class, ResourceUrlProvider.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration", WebMvcAutoConfiguration.EnableWebMvcConfiguration.class).welcomePageNotAcceptableHandlerMapping(args.get(0), args.get(1), args.get(2)));
    }
    ...
    private static BeanInstanceSupplier<FlashMapManager> getFlashMapManagerInstanceSupplier() {
      return BeanInstanceSupplier.<FlashMapManager>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "flashMapManager")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration", WebMvcAutoConfiguration.EnableWebMvcConfiguration.class).flashMapManager());
    }
    ...
    private static BeanInstanceSupplier<RequestToViewNameTranslator> getViewNameTranslatorInstanceSupplier(
      ...
      return BeanInstanceSupplier.<RequestToViewNameTranslator>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "viewNameTranslator")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration", WebMvcAutoConfiguration.EnableWebMvcConfiguration.class).viewNameTranslator());
    }
    ...
    private static BeanInstanceSupplier<FormattingConversionService> getMvcConversionServiceInstanceSupplier(
      ...
      return BeanInstanceSupplier.<FormattingConversionService>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "mvcConversionService")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration", WebMvcAutoConfiguration.EnableWebMvcConfiguration.class).mvcConversionService());
    }
    ...
    private static BeanInstanceSupplier<Validator> getMvcValidatorInstanceSupplier() {
      return BeanInstanceSupplier.<Validator>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "mvcValidator")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration", WebMvcAutoConfiguration.EnableWebMvcConfiguration.class).mvcValidator());
    }
    ...
    private static BeanInstanceSupplier<RequestMappingHandlerMapping> getRequestMappingHandlerMappingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<RequestMappingHandlerMapping>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "requestMappingHandlerMapping", ContentNegotiationManager.class, ApiVersionStrategy.class, FormattingConversionService.class, ResourceUrlProvider.class);
    }
    ...
    /**
     * Get the bean instance supplier for 'mvcApiVersionStrategy'.
     */
    private static BeanInstanceSupplier<ApiVersionStrategy> getMvcApiVersionStrategyInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<ApiVersionStrategy>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "mvcApiVersionStrategy")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration", WebMvcAutoConfiguration.EnableWebMvcConfiguration.class).mvcApiVersionStrategy());
    }

    /**
     * Get the bean definition for 'mvcApiVersionStrategy'.
     */
    public static BeanDefinition getMvcApiVersionStrategyBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(ApiVersionStrategy.class);
      beanDefinition.setFactoryBeanName("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$EnableWebMvcConfiguration");
      beanDefinition.setInstanceSupplier(getMvcApiVersionStrategyInstanceSupplier());
      return beanDefinition;
    }
    ...
    private static BeanInstanceSupplier<RouterFunctionMapping> getRouterFunctionMappingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<RouterFunctionMapping>forFactoryMethod(WebMvcAutoConfiguration.EnableWebMvcConfiguration.class, "routerFunctionMapping", FormattingConversionService.class, ResourceUrlProvider.class, ApiVersionStrategy.class);
    }
  ...
  /**
   * Bean definitions for {@link WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration}.
   */
  @Generated
  public static class ResourceChainCustomizerConfiguration {
    /**
     * Get the bean definition for 'resourceChainCustomizerConfiguration'.
     */
    public static BeanDefinition getResourceChainCustomizerConfigurationBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration.class);
      beanDefinition.setInstanceSupplier(WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration::new);
      return beanDefinition;
    }

    /**
     * Get the bean instance supplier for 'resourceHandlerRegistrationCustomizer'.
     */
    private static BeanInstanceSupplier<WebMvcAutoConfiguration.ResourceChainResourceHandlerRegistrationCustomizer> getResourceHandlerRegistrationCustomizerInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<WebMvcAutoConfiguration.ResourceChainResourceHandlerRegistrationCustomizer>forFactoryMethod(WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration.class, "resourceHandlerRegistrationCustomizer", WebProperties.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$ResourceChainCustomizerConfiguration", WebMvcAutoConfiguration.ResourceChainCustomizerConfiguration.class).resourceHandlerRegistrationCustomizer(args.get(0)));
    }

    /**
     * Get the bean definition for 'resourceHandlerRegistrationCustomizer'.
     */
    public static BeanDefinition getResourceHandlerRegistrationCustomizerBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(WebMvcAutoConfiguration.ResourceChainResourceHandlerRegistrationCustomizer.class);
      beanDefinition.setFactoryBeanName("org.springframework.boot.webmvc.autoconfigure.WebMvcAutoConfiguration$ResourceChainCustomizerConfiguration");
      beanDefinition.setInstanceSupplier(getResourceHandlerRegistrationCustomizerInstanceSupplier());
      return beanDefinition;
    }
  }
}
