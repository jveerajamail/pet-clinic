 ...
 */
@Generated
public class MultipartAutoConfiguration__TestContext005_BeanDefinitions {
  /**
   * Get the bean instance supplier for 'org.springframework.boot.servlet.autoconfigure.MultipartAutoConfiguration'.
   */
  ...
  private static BeanInstanceSupplier<MultipartConfigElement> getMultipartConfigElementInstanceSupplier(
    ...
    return BeanInstanceSupplier.<MultipartConfigElement>forFactoryMethod(MultipartAutoConfiguration.class, "multipartConfigElement")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.servlet.autoconfigure.MultipartAutoConfiguration", MultipartAutoConfiguration.class).multipartConfigElement());
  }
  ...
  public static BeanDefinition getMultipartConfigElementBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.servlet.autoconfigure.MultipartAutoConfiguration");
  ...
  private static BeanInstanceSupplier<StandardServletMultipartResolver> getMultipartResolverInstanceSupplier(
    ...
    return BeanInstanceSupplier.<StandardServletMultipartResolver>forFactoryMethod(MultipartAutoConfiguration.class, "multipartResolver")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.servlet.autoconfigure.MultipartAutoConfiguration", MultipartAutoConfiguration.class).multipartResolver());
  }
