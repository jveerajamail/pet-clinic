 ...
 */
@Generated
public class TestEntityManagerAutoConfiguration__TestContext004_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<TestEntityManager> getTestEntityManagerInstanceSupplier() {
    return BeanInstanceSupplier.<TestEntityManager>forFactoryMethod(TestEntityManagerAutoConfiguration.class, "testEntityManager", EntityManagerFactory.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.jpa.test.autoconfigure.TestEntityManagerAutoConfiguration", TestEntityManagerAutoConfiguration.class).testEntityManager(args.get(0)));
  }
  ...
  public static BeanDefinition getTestEntityManagerBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.jpa.test.autoconfigure.TestEntityManagerAutoConfiguration");
