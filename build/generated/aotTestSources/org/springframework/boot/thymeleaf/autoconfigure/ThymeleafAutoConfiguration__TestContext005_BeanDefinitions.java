 ...
 */
@Generated
public class ThymeleafAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  public static class ThymeleafWebMvcConfiguration {
    ...
    private static BeanInstanceSupplier<FilterRegistrationBean> getResourceUrlEncodingFilterInstanceSupplier(
      ...
      return BeanInstanceSupplier.<FilterRegistrationBean>forFactoryMethod(ThymeleafAutoConfiguration.ThymeleafWebMvcConfiguration.class, "resourceUrlEncodingFilter")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.thymeleaf.autoconfigure.ThymeleafAutoConfiguration$ThymeleafWebMvcConfiguration", ThymeleafAutoConfiguration.ThymeleafWebMvcConfiguration.class).resourceUrlEncodingFilter());
    }
    ...
    public static BeanDefinition getResourceUrlEncodingFilterBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.thymeleaf.autoconfigure.ThymeleafAutoConfiguration$ThymeleafWebMvcConfiguration");
