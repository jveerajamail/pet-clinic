 ...
 */
@Generated
public class JdbcClientAutoConfiguration__TestContext004_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<JdbcClient> getJdbcClientInstanceSupplier() {
    return BeanInstanceSupplier.<JdbcClient>forFactoryMethod(JdbcClientAutoConfiguration.class, "jdbcClient", NamedParameterJdbcTemplate.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.jdbc.autoconfigure.JdbcClientAutoConfiguration", JdbcClientAutoConfiguration.class).jdbcClient(args.get(0)));
  }
  ...
  public static BeanDefinition getJdbcClientBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.jdbc.autoconfigure.JdbcClientAutoConfiguration");
