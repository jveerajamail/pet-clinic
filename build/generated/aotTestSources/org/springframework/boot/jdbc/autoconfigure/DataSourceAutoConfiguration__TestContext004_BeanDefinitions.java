 ...
 */
@Generated
public class DataSourceAutoConfiguration__TestContext004_BeanDefinitions {
  /**
  ...
  public static class PooledDataSourceConfiguration {
    ...
    private static BeanInstanceSupplier<PropertiesJdbcConnectionDetails> getJdbcConnectionDetailsInstanceSupplier(
      ...
      return BeanInstanceSupplier.<PropertiesJdbcConnectionDetails>forFactoryMethod(DataSourceAutoConfiguration.PooledDataSourceConfiguration.class, "jdbcConnectionDetails", DataSourceProperties.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.jdbc.autoconfigure.DataSourceAutoConfiguration$PooledDataSourceConfiguration", DataSourceAutoConfiguration.PooledDataSourceConfiguration.class).jdbcConnectionDetails(args.get(0)));
    }
    ...
    public static BeanDefinition getJdbcConnectionDetailsBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.jdbc.autoconfigure.DataSourceAutoConfiguration$PooledDataSourceConfiguration");
