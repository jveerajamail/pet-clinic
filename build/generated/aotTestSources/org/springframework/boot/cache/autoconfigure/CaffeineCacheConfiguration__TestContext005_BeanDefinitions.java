 ...
 */
@Generated
public class CaffeineCacheConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<CaffeineCacheManager> getCacheManagerInstanceSupplier() {
    return BeanInstanceSupplier.<CaffeineCacheManager>forFactoryMethod(CaffeineCacheConfiguration.class, "cacheManager", CacheProperties.class, CacheManagerCustomizers.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.cache.autoconfigure.CaffeineCacheConfiguration", CaffeineCacheConfiguration.class).cacheManager(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4)));
  }
  ...
  public static BeanDefinition getCacheManagerBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.cache.autoconfigure.CaffeineCacheConfiguration");
