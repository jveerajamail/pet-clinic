 ...
 */
@Generated
public class CacheAutoConfiguration__TestContext003_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<CacheManagerCustomizers> getCacheManagerCustomizersInstanceSupplier(
    ...
    return BeanInstanceSupplier.<CacheManagerCustomizers>forFactoryMethod(CacheAutoConfiguration.class, "cacheManagerCustomizers", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.cache.autoconfigure.CacheAutoConfiguration", CacheAutoConfiguration.class).cacheManagerCustomizers(args.get(0)));
  }
  ...
  public static BeanDefinition getCacheManagerCustomizersBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.cache.autoconfigure.CacheAutoConfiguration");
  ...
  private static BeanInstanceSupplier<CacheAutoConfiguration.CacheManagerValidator> getCacheAutoConfigurationValidatorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<CacheAutoConfiguration.CacheManagerValidator>forFactoryMethod(CacheAutoConfiguration.class, "cacheAutoConfigurationValidator", CacheProperties.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.cache.autoconfigure.CacheAutoConfiguration", CacheAutoConfiguration.class).cacheAutoConfigurationValidator(args.get(0), args.get(1)));
  }
  ...
  /**
   * Bean definitions for {@link CacheAutoConfiguration.CacheManagerEntityManagerFactoryDependsOnConfiguration}.
   */
  @Generated
  public static class CacheManagerEntityManagerFactoryDependsOnConfiguration {
    /**
     * Get the bean definition for 'cacheManagerEntityManagerFactoryDependsOnConfiguration'.
     */
    public static BeanDefinition getCacheManagerEntityManagerFactoryDependsOnConfigurationBeanDefinition(
        ) {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(CacheAutoConfiguration.CacheManagerEntityManagerFactoryDependsOnConfiguration.class);
      beanDefinition.setInstanceSupplier(CacheAutoConfiguration.CacheManagerEntityManagerFactoryDependsOnConfiguration::new);
      return beanDefinition;
    }
  }
