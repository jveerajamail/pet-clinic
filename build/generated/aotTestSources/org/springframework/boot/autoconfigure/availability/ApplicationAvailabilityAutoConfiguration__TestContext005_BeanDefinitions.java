 ...
 */
@Generated
public class ApplicationAvailabilityAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<ApplicationAvailabilityBean> getApplicationAvailabilityInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ApplicationAvailabilityBean>forFactoryMethod(ApplicationAvailabilityAutoConfiguration.class, "applicationAvailability")
            .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.availability.ApplicationAvailabilityAutoConfiguration", ApplicationAvailabilityAutoConfiguration.class).applicationAvailability());
  }
  ...
  public static BeanDefinition getApplicationAvailabilityBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.availability.ApplicationAvailabilityAutoConfiguration");
