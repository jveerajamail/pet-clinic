 ...
 */
@Generated
public class LifecycleAutoConfiguration__TestContext005_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<DefaultLifecycleProcessor> getLifecycleProcessorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<DefaultLifecycleProcessor>forFactoryMethod(LifecycleAutoConfiguration.class, "defaultLifecycleProcessor", LifecycleProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.context.LifecycleAutoConfiguration", LifecycleAutoConfiguration.class).defaultLifecycleProcessor(args.get(0)));
  }
  ...
  public static BeanDefinition getLifecycleProcessorBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.context.LifecycleAutoConfiguration");
