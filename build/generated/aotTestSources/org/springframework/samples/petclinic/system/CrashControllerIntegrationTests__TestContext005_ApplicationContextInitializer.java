 ...
 */
@Generated
public class CrashControllerIntegrationTests__TestContext005_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CrashControllerIntegrationTests__TestContext005_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CrashControllerIntegrationTests__TestContext005_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
